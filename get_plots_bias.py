...
#pusher
#'''''
df_gcsl_0 = pd.read_csv('data/example/pusher/gcsl_sto_off_ 0/2022_01_13_00_44_33/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/pusher/gcsl_sto_off_ 1/2022_01_13_00_44_33/progress.csv')
...
#'''''
n_df_gcsl_0 = pd.read_csv('data/example/pusher/norm_sto_ 0/2022_01_13_08_22_22/progress.csv')
n_df_gcsl_1 = pd.read_csv('data/example/pusher/norm_sto_ 1/2022_01_13_08_22_22/progress.csv')
n_df_gcsl_2 = pd.read_csv('data/example/pusher/norm_sto_ 2/2022_01_13_08_22_22/progress.csv')
...
s_l = df_gcsl_4['Eval success ratio_left'].values
s_r = df_gcsl_4['Eval success ratio_right'].values

n_s_l = n_df_gcsl_4['Eval success ratio_left'].values
n_s_r = n_df_gcsl_4['Eval success ratio_right'].values
...
plt.plot(time_0,s_r,'b', label = 'M4')
plt.plot(n_time_0,n_s_r,'r', label = 'N_M4')

plt.xlabel('TimeSteps')
plt.ylabel('Success')
plt.legend()
plt.title('Success - M4 - Right -' + env )
plt.grid()
plt.show()
