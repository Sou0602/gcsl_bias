...
#pusher
#'''''
df_gcsl_0 = pd.read_csv('/home/nsh1609/gcsl-norm/data/example/pusher/gcsl_o_1/2022_01_09_12_17_55/progress.csv')
...
#'''''
n_df_gcsl_0 = pd.read_csv('data/example/pusher/norm_sto_nb1_on 0/2022_01_15_11_42_26/progress.csv')
...
plt.plot(time_0,success_0,'b', label = 'M0')
plt.plot(n_time_0,n_success_0,'r', label = 'N_M0')
