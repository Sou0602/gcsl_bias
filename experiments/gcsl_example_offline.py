...
def run(output_dir='/tmp', env_name='pointmass_empty', gpu=True, seed=0, **kwargs):
    ...
    # Algo
    from gcsl.algo import buffer, gcsl, variants_off, networks_off,gcsl_offline
    ...
    env, policy, replay_buffer, gcsl_kwargs = variants_off.get_params(env, env_params)
    ...
    exp_prefix = 'example/%s/gcsl_off_o/' % (env_name,)
