...
df_gcsl_n = pd.read_csv('data/example/door/gcsl_off_n11_sto/2022_01_10_22_37_40/progress.csv')
df_gcsl = pd.read_csv('data/example/door/gcsl_od/2021_12_24_09_55_33/progress.csv')
df_gcsl_s = pd.read_csv('data/example/door/gcsl_off_o/2022_01_10_13_24_35/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_04_10_18_53/progress.csv')
df_gcsl_n = pd.read_csv('data/example/pusher/gcsl_off_n11_sto/2022_01_10_22_37_39/progress.csv')
df_gcsl = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_09_55_32/progress.csv')
df_gcsl_s = pd.read_csv('data/example/pusher/gcsl_off_o/2022_01_10_13_24_34/progress.csv')
#'''''
'''''
#lunar
df_gcsl_nt = pd.read_csv('data/example/lunar/gcsl_mt2/2022_01_04_09_07_39/progress.csv')
df_gcsl_n = pd.read_csv('data/example/lunar/gcsl_off_n11_sto/2022_01_10_22_37_39/progress.csv')
df_gcsl = pd.read_csv('data/example/lunar/gcsl_od/2021_12_24_09_55_32/progress.csv')
df_gcsl_s = pd.read_csv('data/example/lunar/gcsl_off_o/2022_01_10_13_24_35/progress.csv')
'''''
'''''
#pointmass_rooms
df_gcsl_nt = pd.read_csv('data/example/pointmass_rooms/gcsl_mt2/2022_01_04_09_07_39/progress.csv')
df_gcsl_n = pd.read_csv('data/example/pointmass_rooms/gcsl_off_n11_sto/2022_01_10_22_37_39/progress.csv')
df_gcsl = pd.read_csv('data/example/pointmass_rooms/gcsl_od/2021_12_24_09_55_32/progress.csv')
df_gcsl_s = pd.read_csv('data/example/pointmass_rooms/gcsl_off_o/2022_01_10_13_24_34/progress.csv')
'''''
'''''
#pointmass_empty
df_gcsl_nt = pd.read_csv('data/example/pointmass_empty/gcsl_mt2/2022_01_05_09_10_45/progress.csv')
df_gcsl_n = pd.read_csv('data/example/pointmass_empty/gcsl_off_n11_sto/2022_01_10_22_37_39/progress.csv')
df_gcsl = pd.read_csv('data/example/pointmass_empty/gcsl_od/2021_12_24_09_55_32/progress.csv')
df_gcsl_s = pd.read_csv('data/example/pointmass_empty/gcsl_off_o/2022_01_10_13_24_34/progress.csv')
'''''
...
df_gcsl_n_1 = pd.read_csv('data/example/door/gcsl_off_n11_sto/2022_01_11_01_58_13/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/door/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/door/gcsl_off_o/2022_01_10_15_44_12/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt_1 = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_05_00_00_28/progress.csv')
df_gcsl_n_1 = pd.read_csv('data/example/pusher/gcsl_off_n11_sto/2022_01_11_01_58_12/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/pusher/gcsl_off_o/2022_01_10_15_44_12/progress.csv')
#'''''
'''''
#lunar
df_gcsl_nt_1 = pd.read_csv('data/example/lunar/gcsl_mt2/2022_01_05_00_00_28/progress.csv')
df_gcsl_n_1 = pd.read_csv('data/example/lunar/gcsl_off_n11_sto/2022_01_11_01_58_12/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/lunar/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/lunar/gcsl_off_o/2022_01_10_15_44_12/progress.csv')
'''''
'''''
#pointmass_rooms
df_gcsl_nt_1 = pd.read_csv('data/example/pointmass_rooms/gcsl_mt2/2022_01_05_00_00_27/progress.csv')
df_gcsl_n_1 = pd.read_csv('data/example/pointmass_rooms/gcsl_off_n11_sto/2022_01_11_01_58_12/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/pointmass_rooms/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/pointmass_rooms/gcsl_off_o/2022_01_10_15_44_11/progress.csv')
'''''
'''''
#pointmass_empty
df_gcsl_nt_1 = pd.read_csv('data/example/pointmass_empty/gcsl_mt2/2022_01_05_00_00_28/progress.csv')
df_gcsl_n_1 = pd.read_csv('data/example/pointmass_empty/gcsl_off_n11_sto/2022_01_11_01_58_12/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/pointmass_empty/gcsl_od/2021_12_24_12_09_26/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/pointmass_empty/gcsl_off_o/2022_01_10_15_44_12/progress.csv')
'''''
...
df_gcsl_n_2 = pd.read_csv('data/example/door/gcsl_off_n11_sto/2022_01_11_04_33_24/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/door/gcsl_od/2021_12_24_14_27_57/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/door/gcsl_off_o/2022_01_10_17_24_23/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt_2 = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_05_03_34_59/progress.csv')
df_gcsl_n_2 = pd.read_csv('data/example/pusher/gcsl_off_n11_sto/2022_01_11_04_33_23/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_14_27_56/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/pusher/gcsl_off_o/2022_01_10_17_24_21/progress.csv')
#'''''
'''''
#lunar
df_gcsl_nt_2 = pd.read_csv('data/example/lunar/gcsl_mt2/2022_01_05_03_35_00/progress.csv')
df_gcsl_n_2 = pd.read_csv('data/example/lunar/gcsl_off_n11_sto/2022_01_11_04_33_23/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/lunar/gcsl_od/2021_12_24_14_27_56/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/lunar/gcsl_off_o/2022_01_10_17_24_21/progress.csv')
'''''
'''''
#pointmass_rooms
df_gcsl_nt_2 = pd.read_csv('data/example/pointmass_rooms/gcsl_mt2/2022_01_05_03_35_00/progress.csv')
df_gcsl_n_2 = pd.read_csv('data/example/pointmass_rooms/gcsl_off_n11_sto/2022_01_11_04_33_23/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/pointmass_rooms/gcsl_od/2021_12_24_14_27_56/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/pointmass_rooms/gcsl_off_o/2022_01_10_17_24_22/progress.csv')
'''''
'''''
#pointmass_empty
df_gcsl_nt_2 = pd.read_csv('data/example/pointmass_empty/gcsl_mt2/2022_01_05_03_34_59/progress.csv')
df_gcsl_n_2 = pd.read_csv('data/example/pointmass_empty/gcsl_off_n11_sto/2022_01_11_04_33_23/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/pointmass_empty/gcsl_od/2021_12_24_14_27_56/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/pointmass_empty/gcsl_off_o/2022_01_10_17_24_22/progress.csv')
'''''
...
plt.plot(time,a_n_success,'r',label = 'Norm_Sto')
...
plt.grid()
#plt.show()
plt.savefig('plots_new/'+env+'_off/success.jpg')
plt.close()
...
plt.plot(time,a_n_avg_dist,'r',label = 'Norm_Sto')
...
plt.grid()
#plt.show()
plt.savefig('plots_new/'+env+'_off/avg_dist.jpg')
plt.close()
...
plt.plot(time,a_n_loss,'r',label = 'Norm_Sto')
...
plt.grid()
#plt.show()
plt.savefig('plots_new/'+env+'_off/loss.jpg')
plt.close()
